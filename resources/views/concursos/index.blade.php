                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('revisor'))
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger btn-sm btn-block mb-1" onclick="
                                        ...
                                        <a href="{{ route('ver-postulaciones-concursos-registrados-administrador', Crypt::encrypt($post->idcomp)) }}" class="btn btn-warning btn-sm btn-block mb-1">
                                            Ver Postulaciones
                                        </a>
                                        @endif
                                    @endif
