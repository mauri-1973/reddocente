    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="">
                    <h3>
                    {{ __('lang.addnewuser') }} ({{ trans('multi-leng.multi3')}})
                    </h3>
                </div>
                <div class="card-body">
                    <form id="form_validation" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{old('email')}}" placeholder="{{ __('lang.email') }}" maxlength="100" autofocus required>
                            @error('email')
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="password"  name="password" placeholder="Password" minlength="6" maxlength="10" autofocus required>
                            @error('password')
    ...
    $( "#form_validation" ).submit(function( event ) 
        {
            ...
            else
            {
                ...
                $( "#subcat" ).val(escapeHtml($( "#subcat" ).val()));
                return true;
            }
        });
