                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-white">
                                        ...
                                        <a href="{{ route('iniciar-correciones-formulario-revisor', Crypt::encrypt($answ[0]->idansw) ) }}" onclick="window.open(this.href, 'Correciones Formulario', `height=${screen.height},width=${screen.width}, resizable=1`); return false;" class="btn btn-warning btn-sm btn-block" style="display:{{ $display }}">Iniciar Correcciones&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-white">
