                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-white">
                                        ...
                                        <a href="{{ route('imprimr-formulario-revisor-observaciones', Crypt::encrypt($answ[0]->idansw)) }}" role="button" id="imprimir" class="btn btn-warning btn-sm btn-block" style="display:{{ $display }}">{{ trans('multi-leng.a249')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <table class="table table-bordered table-sm" id="tablainicio2" style="background-color:#fff;">
                                                <thead>
                                                    <tr>
                                                        <th>&nbsp;</th>
                                                        <th>&nbsp;</th>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <table class="table table-bordered table-sm" style="background-color:#fff;" id="tablainicio3">
                                                <thead>
                                                    <tr>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <table class="table table-bordered table-sm" style="background-color:#fff;" id="tablainicio4">
                                                <thead>
                                                    <tr>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <table class="table table-bordered table-sm" style="background-color:#fff;" id="tablainicio5">
                                                <thead>
                                                    <tr>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <a href="{{ route('imprimr-formulario-revisor', Crypt::encrypt($answ[0]->idansw)) }}" role="button" id="imprimir" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a204')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                    </div>
                                                    @role('admin')
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    @role('revisor')
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <a href="{{ route('buscar-concursos-registrados-revisor' ) }}" class="btn btn-warning btn-sm btn-block">{{ trans('multi-leng.lognav')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                    </div>
                                                    @endrole
                                                </div>
                                            </div>
